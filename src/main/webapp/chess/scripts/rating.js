$(function() {
	...
	var datasets = {
		...
		"Navara" : {
			label : "Navara",
			data : [ [ 2000, 2443 ], [ 2001, 2466 ], [ 2002, 2531 ],
					[ 2003, 2580 ], [ 2004, 2604 ], [ 2005, 2644 ],
					[ 2006, 2660 ], [ 2007, 2719 ], [ 2008, 2680 ],
					[ 2009, 2638 ], [ 2010, 2708 ], [ 2011, 2708 ],
					[ 2012, 2712 ], [ 2013, 2710 ], [ 2014, 2702 ],
					[ 2015, 2714 ] ]
		},
		"Wang-Hao" : {
			label : "Wang, Hao",
			data : [ [ 2002, 2194 ], [ 2003, 2215 ], [ 2004, 2425 ],
					[ 2005, 2457 ], [ 2006, 2593 ], [ 2007, 2619 ],
					[ 2008, 2665 ], [ 2009, 2691 ], [ 2010, 2715 ],
					[ 2011, 2731 ], [ 2012, 2733 ], [ 2013, 2752 ],
					[ 2014, 2734 ], [ 2015, 2713 ] ]
		},
		"Li-Chao" : {
			label : "Li, Chao",
			data : [ [ 2005, 2305 ], [ 2006, 2440 ], [ 2007, 2504 ],
					[ 2008, 2566 ], [ 2009, 2628 ], [ 2010, 2604 ],
					[ 2011, 2649 ], [ 2012, 2693 ], [ 2013, 2674 ],
					[ 2014, 2680 ], [ 2015, 2711 ] ]
		},
		"Wang-Yue" : {
			label : "Wang, Yue",
			data : [ [ 2000, 2437 ], [ 2001, 2439 ], [ 2002, 2454 ],
					[ 2003, 2492 ], [ 2004, 2493 ], [ 2005, 2549 ],
					[ 2006, 2599 ], [ 2007, 2644 ], [ 2008, 2698 ],
					[ 2009, 2739 ], [ 2010, 2749 ], [ 2011, 2734 ],
					[ 2012, 2694 ], [ 2013, 2702 ], [ 2014, 2717 ],
					[ 2015, 2711 ] ]
		},
		"Bu-Xiangzhi" : {
			label : "Bu, Xiangzhi",
			data : [ [ 2000, 2565 ], [ 2001, 2558 ], [ 2002, 2593 ],
					[ 2003, 2569 ], [ 2004, 2600 ], [ 2005, 2607 ],
					[ 2006, 2645 ], [ 2007, 2644 ], [ 2008, 2691 ],
					[ 2009, 2702 ], [ 2010, 2673 ], [ 2011, 2677 ],
					[ 2012, 2670 ], [ 2013, 2675 ], [ 2014, 2699 ],
					[ 2015, 2710 ] ]
		},
		"Nepomniachtchi" : {
			label : "Nepomniachtchi",
			data : [ [ 2001, 2243 ], [ 2002, 2280 ], [ 2003, 2368 ],
					[ 2004, 2433 ], [ 2005, 2483 ], [ 2006, 2506 ],
					[ 2007, 2587 ], [ 2008, 2600 ], [ 2009, 2628 ],
					[ 2010, 2658 ], [ 2011, 2733 ], [ 2012, 2735 ],
					[ 2013, 2703 ], [ 2014, 2732 ], [ 2015, 2710 ] ]
		},
		"Kryvoruchko" : {
			label : "Kryvoruchko",
			data : [ [ 2001, 2148 ], [ 2002, 2154 ], [ 2003, 2355 ],
					[ 2004, 2413 ], [ 2005, 2474 ], [ 2006, 2513 ],
					[ 2007, 2592 ], [ 2008, 2597 ], [ 2009, 2604 ],
					[ 2010, 2598 ], [ 2011, 2640 ], [ 2012, 2666 ],
					[ 2013, 2666 ], [ 2014, 2704 ], [ 2015, 2710 ] ]
		},
		"Jobava" : {
			label : "Jobava",
			data : [ [ 2000, 2430 ], [ 2001, 2518 ], [ 2002, 2556 ],
					[ 2003, 2559 ], [ 2004, 2616 ], [ 2005, 2640 ],
					[ 2006, 2614 ], [ 2007, 2650 ], [ 2008, 2643 ],
					[ 2009, 2669 ], [ 2010, 2704 ], [ 2011, 2707 ],
					[ 2012, 2704 ], [ 2013, 2702 ], [ 2014, 2710 ],
					[ 2015, 2708 ] ]
		},
		"Kasimdzhanov" : {
			label : "Kasimdzhanov",
			data : [ [ 2000, 2614 ], [ 2001, 2693 ], [ 2002, 2695 ],
					[ 2003, 2676 ], [ 2004, 2652 ], [ 2005, 2678 ],
					[ 2006, 2670 ], [ 2007, 2682 ], [ 2008, 2681 ],
					[ 2009, 2687 ], [ 2010, 2702 ], [ 2011, 2681 ],
					[ 2012, 2689 ], [ 2013, 2709 ], [ 2014, 2698 ],
					[ 2015, 2706 ] ]
		},
		"Le-Quang-Liem" : {
			label : "Le, Quang Liem",
			data : [ [ 2002, 2148 ], [ 2003, 2202 ], [ 2004, 2297 ],
					[ 2005, 2336 ], [ 2006, 2422 ], [ 2007, 2500 ],
					[ 2008, 2540 ], [ 2009, 2591 ], [ 2010, 2647 ],
					[ 2011, 2664 ], [ 2012, 2714 ], [ 2013, 2705 ],
					[ 2014, 2703 ], [ 2015, 2706 ] ]
		},
		"Shirov" : {
			label : "Shirov",
			data : [ [ 2000, 2751 ], [ 2001, 2718 ], [ 2002, 2715 ],
					[ 2003, 2723 ], [ 2004, 2736 ], [ 2005, 2713 ],
					[ 2006, 2709 ], [ 2007, 2715 ], [ 2008, 2755 ],
					[ 2009, 2745 ], [ 2010, 2723 ], [ 2011, 2722 ],
					[ 2012, 2710 ], [ 2013, 2708 ], [ 2014, 2711 ],
					[ 2015, 2701 ] ]
		},
		"Tomashevsky" : {
			label : "Tomashevsky",
			data : [ [ 2000, 2300 ], [ 2001, 2408 ], [ 2002, 2452 ],
					[ 2003, 2444 ], [ 2004, 2480 ], [ 2005, 2540 ],
					[ 2006, 2586 ], [ 2007, 2624 ], [ 2008, 2646 ],
					[ 2009, 2664 ], [ 2010, 2705 ], [ 2011, 2695 ],
					[ 2012, 2740 ], [ 2013, 2722 ], [ 2014, 2715 ],
					[ 2015, 2701 ] ]
		}
	};
